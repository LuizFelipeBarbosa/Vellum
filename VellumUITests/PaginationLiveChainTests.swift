...
private struct PaginationHarness: View {
    ...
    init(pageState: NotePageState, canvasReference: NoteCanvasReference) {
...
final class PaginationLiveChainTests: XCTestCase {
    func testFreshHarnessShowsTwoPages() throws {
        ...
        let expectedContentHeight = 2 * PageLayout.pageHeight * host.canvasView.zoomScale
    ...
    func testInkOnPageTwoGrowsToThreePages() throws {
        ...
        let expectedContentHeight = 3 * PageLayout.pageHeight * host.canvasView.zoomScale
        let actualContentHeight = host.canvasView.contentSize.height
    ...
    func testInkAtPageTwoBottomViaViewportSpace() throws {
        ...
        let pageTwoRect = PageLayout.pageRect(index: 1)
        ...
        let expectedPageCount = PageLayout.pageCount(forContentBottom: targetContentY)
        let actualPageCount = host.pageState.pageCount
