...
final class ImageImportTests: XCTestCase {
    ...
    func testImageImportRoundTripsAssetElementAndCache() async throws {
        ...
        XCTAssertEqual(
            ...
            Double(PageLayout.portraitContentWidth) - importedElement.frame.width,
            accuracy: 2
        )
        XCTAssertEqual(
    ...
    func testImageImportClampsWidthToPageWidthForWideImage() async throws {
        ...
        XCTAssertEqual(importedElement.frame.width, Double(PageLayout.portraitContentWidth), accuracy: 2)
        XCTAssertEqual(
