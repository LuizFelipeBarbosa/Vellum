...
public enum PageLayout {
    /// Logical canvas width for an upright portrait page in device-independent content points.
    public static let portraitContentWidth: CGFloat = 768
    ...
    public static func minZoom(
        forViewportWidth width: CGFloat,
        contentWidth: CGFloat
    ) -> CGFloat {
        guard width > 0, contentWidth > 0 else { return 1 }
    ...
    public static func snapTargetZoom(
        ...
        guard width > 0, contentWidth > 0 else { return nil }

        let fit = minZoom(forViewportWidth: width, contentWidth: contentWidth)
    ...
    public static func overviewMinZoom(
        forViewportWidth width: CGFloat,
        contentWidth: CGFloat
    ) -> CGFloat {
        overviewZoomFactor * minZoom(
    ...
    public static func maxZoom(
        forViewportWidth width: CGFloat,
        contentWidth: CGFloat
    ) -> CGFloat {
        4 * minZoom(forViewportWidth: width, contentWidth: contentWidth)
    }
    ...
    public static func elasticMinZoom(
        forViewportWidth width: CGFloat,
        contentWidth: CGFloat
    ) -> CGFloat {
        (1 - zoomOvershootFactor) * overviewMinZoom(
            forViewportWidth: width,
            contentWidth: contentWidth
        )
    }
    ...
    public static func elasticMaxZoom(
        forViewportWidth width: CGFloat,
        contentWidth: CGFloat
    ) -> CGFloat {
        (1 + zoomOvershootFactor / 2) * maxZoom(
            forViewportWidth: width,
            contentWidth: contentWidth
        )
    }
    ...
    public static func settleTargetZoom(
        ...
        guard width > 0, contentWidth > 0, scale > 0 else { return nil }
        let floor = overviewMinZoom(
            forViewportWidth: width,
            contentWidth: contentWidth
        )
        let ceiling = maxZoom(forViewportWidth: width, contentWidth: contentWidth)
        if scale < floor { return floor }
        if scale > ceiling { return ceiling }
        return snapTargetZoom(
